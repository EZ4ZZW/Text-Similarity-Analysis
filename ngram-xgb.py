...
sns.barplot(count_str.index[0:20], count_str.values[0:20], alpha=0.8, color=color[0])
plt.ylabel('Number of Occurrences', fontsize=12)
...
plt.figure(figsize=(12,6))
sns.barplot(count_str.index[0:20], count_str.values[0:20], alpha=0.8, color=color[3])
...
plt.figure(figsize=(12,6))
sns.barplot(count_str.index[:20], count_str.values[:20], alpha=0.8)
plt.ylabel('Number of Occurrences', fontsize=12)
...
plt.figure(figsize=(12,6))
sns.barplot(count_str.index[0:10], count_str.values[0:10], alpha=0.8)
...
out_df.to_csv("/content/drive/My Drive/ml/singleData2333.csv", index=False)
